...
import { CUSTOMER_TAG_ITEM_LABELS } from '../../hooks/useCustomerTagVisibility';

interface CustomerTagVisibilityDropdownProps {
  visibleItems: Set<CustomerTagItemId>;
  onToggle: (itemId: CustomerTagItemId) => void;
  allItems: CustomerTagItemId[];
}

const CustomerTagVisibilityDropdown: React.FC<CustomerTagVisibilityDropdownProps> = ({
  visibleItems,
  onToggle,
  allItems,
}) => {
    ...
    <div className="py-1">
      ...
      {allItems.map((itemId) => {
        ...
        return (
          ...
          >
            <span>{CUSTOMER_TAG_ITEM_LABELS[itemId]}</span>
            <div
...
export default CustomerTagVisibilityDropdown;
